...
update()
{
    set_open_hour(Database::settings_search("open_hour").toInt());
    set_open_min(Database::settings_search("open_min").toInt());
    set_close_hour(Database::settings_search("close_hour").toInt());
    set_close_min(Database::settings_search("close_min").toInt());
    set_min_rental(Database::settings_search("min_rental").toInt());
}
